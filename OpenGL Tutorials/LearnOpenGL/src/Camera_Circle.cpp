...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Camera Circle", NULL, NULL);
	if (window == NULL)
	{
    ...
    if (imgData)
    {
        printf("Image 1 Loaded Succesfully \n");
    ...
    if (imgData)
    {
        printf("Image 2 Loaded Succesfully \n");
