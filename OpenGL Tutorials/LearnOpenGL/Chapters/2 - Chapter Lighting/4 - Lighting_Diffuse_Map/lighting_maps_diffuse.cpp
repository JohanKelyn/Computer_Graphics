...
const char* title = "Lighting Maps Diffuse";
float background[] = { 0.2, 0.2, 0.2 };
...
int main() {
    ...
    glm::mat4 projection = glm::perspective(glm::radians(camera.Zoom), (float)WIDTH / (float)HEIGHT, 0.01f, 100.0f);
