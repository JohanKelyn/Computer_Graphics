...
int main()
{
    ...
    // -------------------------
    Shader asteroidShader("./src/vShaderSource2.vs", "./src/fShaderSource2.fs");
    Shader planetShader("./src/vShaderSource.vs", "./src/fShaderSource.fs");
